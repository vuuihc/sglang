...
```bash
python .Codex/skills/llm-serving-auto-benchmark/scripts/validate_cookbook_configs.py \
  .Codex/skills/llm-serving-auto-benchmark/configs/cookbook-llm
```
...
```bash
python .Codex/skills/llm-serving-auto-benchmark/scripts/compare_benchmark_results.py \
